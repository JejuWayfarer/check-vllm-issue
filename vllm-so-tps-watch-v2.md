...
|-----------------|--------|--------|--------|--------|------------------|-----------|------|
| 2026-08-05 12:00 | closed | closed | closed | merged | 있음 | #50924 [open] [Bug]: EngineCore dies on first guided-decoding request when dspark sp; #49738 [open] [Bugfix][Structured Output][Spec Decode] Fix async grammar bitmask ali | RESOLVED |
